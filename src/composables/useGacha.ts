...
export const GACHA_POOL: GachaPoolItem[] = [
  { id: 'cat01', name: '三花貓吊飾', rarity: 3, icon: '🐱', img: img('mpbzfcpd-cat_product_01.png'), odds: 0.50 },
  { id: 'cat02', name: '白貓公仔', rarity: 3, icon: '🐱', img: img('mpbzfcpp-cat_product_02.png'), odds: 0.25 },
  { id: 'cat03', name: '虎斑貓磁鐵', rarity: 3, icon: '🐱', img: img('mpbzfcqj-cat_product_05.png'), odds: 0.15 },
  { id: 'cat04', name: '黑貓夜燈（隱藏版）', rarity: 4, icon: '🐈‍⬛', img: img('mpbzfcq0-cat_product_03.png'), odds: 0.08 },
  { id: 'cat05', name: '貓掌肉球鑰匙圈（超隱藏）', rarity: 4, icon: '🐾', img: img('mpbzfcq9-cat_product_04.png'), odds: 0.02 },
]
